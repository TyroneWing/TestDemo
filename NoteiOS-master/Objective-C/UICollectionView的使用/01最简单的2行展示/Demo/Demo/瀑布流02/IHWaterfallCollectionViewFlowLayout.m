//
//  IHWaterfallCollectionViewFlowLayout.m
//  Demo
//
...
@interface  IHWaterfallCollectionViewFlowLayout()
...
@implementation IHWaterfallCollectionViewFlowLayout
...
- (void)prepareLayout {
    ...
    // cell宽度
    _itemWidth = (SCREEN_WIDTH - 1 * _insert) / 2; //
}
